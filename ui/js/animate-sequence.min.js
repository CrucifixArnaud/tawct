...
var items;var i;var _animateSequence=function(e,t,n,r){items=_cleanWhitespace(e).childNodes;if(t=="backward"){i=items.length-1}else if(t=="forward"){i=0}_step(t,n,function(){r()})};var _step=function(e,t,n){if(i<items.length&&e!="backward"||i>=0&&e=="backward"){items[i].classList.toggle("on");if(e=="backward"){i--}else if(e=="forward"){i++}setTimeout(function(){_step(e,t,n)},t)}else{if(n&&typeof n==="function"){n()}}};var _cleanWhitespace=function(e){for(var t=0;t<e.childNodes.length;t++){var n=e.childNodes[t];if(n.nodeType==3&&!/\S/.test(n.nodeValue)){e.removeChild(n);t--}if(n.nodeType==1){_cleanWhitespace(n)}}return e}